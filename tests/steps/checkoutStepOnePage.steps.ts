...
When('Fill first name by {string}, last name by {string} and postal code by {string} then click on continue', async function (this: ICustomWorld, firstName: string, lastName: string, postalCode: string) {
